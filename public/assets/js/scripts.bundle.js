                ...
                !0 === KTUtil.hasClass(n.element, n.options.baseClass + "-on") && "on" === String(i.getAttribute("data-kt-drawer-" + n.name + "-")) ? (n.shown = !0) : (n.shown = !1),
                    !0 === f("activate")
                        ? (KTUtil.addClass(n.element, n.options.baseClass),
                          ...
                          l && (KTUtil.isRTL() ? KTUtil.css(n.element, "left", l) : KTUtil.css(n.element, "right", l)))
                        : (KTUtil.removeClass(n.element, n.options.baseClass),
                          ...
                          l && (KTUtil.isRTL() ? KTUtil.css(n.element, "left", "") : KTUtil.css(n.element, "right", "")),
                          s());
            },
            c = function () {
                !0 === f("overlay") &&
...
var KTScroll = function (e, t) {
    ...
    if (e) {
        var i = { saveState: !0 },
            ...
            a = function () {
                var e, t;
                !0 === m("activate") || !1 === n.element.hasAttribute("data-kt-scroll-activate")
                    ? ((e = f()),
                      null !== (t = s()) && t.length > 0 ? KTUtil.css(n.element, e, t) : KTUtil.css(n.element, e, ""),
                      l(),
                      !0 === m("save-state") && void 0 !== KTCookie && n.id ? n.element.addEventListener("scroll", o) : n.element.removeEventListener("scroll", o),
                      (function () {
        ...
        var r = { offset: 200, releaseOffset: 0, reverse: !1, animation: !0, animationSpeed: "0.3s", animationClass: "animation-slide-in-down" },
            ...
            a = function (e) {
                ...
                !1 !== o &&
                    ...
                    (r = document.documentElement.scrollHeight - window.innerHeight - KTUtil.getScrollTop()),
                    !0 === u
                        ? (t > o && (0 === a || a < r)
                              ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on"), i.setAttribute(n.attributeName2, "on")),
                              ...
                              : (!0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName), i.removeAttribute(n.attributeName2)),
                        ...
                        : (!0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName), i.removeAttribute(n.attributeName2)),
                          !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), (n.eventTriggerState = !0))),
                    a > 0 && (r < a ? n.element.setAttribute("data-kt-sticky-released", "true") : n.element.removeAttribute("data-kt-sticky-released")));
            },
            l = function (e) {
                var t = d("top"),
                    i = d("left"),
                    ...
                    c = u();
                if (
                    (!0 !== e && !0 === d("animation") && (KTUtil.css(n.element, "animationDuration", d("animationSpeed")), KTUtil.animateClass(n.element, "animation " + d("animationClass"))),
        ...
        setThemeMode: function (e, t) {
            !(function (e, t) {
                ...
                document.body.classList.add("page-loading"),
                    "dark" === e
                        ? Promise.all([n("plugins.bundle.css", "plugins.dark.bundle.css"), n("style.bundle.css", "style.dark.bundle.css")])
                              .then(function () {
                                  document.body.classList.add("dark-mode"), document.body.classList.remove("page-loading"), t instanceof Function && t();
                              })
                              .catch(function () {})
                        : "light" === e &&
                          Promise.all([n("plugins.dark.bundle.css", "plugins.bundle.css"), n("style.dark.bundle.css", "style.bundle.css")])
                              .then(function () {
