    ...
    var e = function (e, a) {
        ...
        if (t && !t.classList.contains("initialized")) {
            ...
            new ApexCharts(t, {
                ...
                plotOptions: { radialBar: { hollow: { margin: 0, size: "45%" }, dataLabels: { showOn: "always", name: { show: !1 }, value: { show: !1 } }, track: { background: r, strokeWidth: "100%" } } },
                colors: [o],
    ...
    var e = function (e, a, t) {
        ...
        if (l && !l.classList.contains("initialized")) {
            ...
            new ApexCharts(l, {
                ...
                fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.3, opacityTo: 0.7, stops: [0, 90, 100] } },
...
var KTTablesWidget14 = (function () {
    ...
    return {
        init: function () {
            e("#kt_table_widget_14_chart_1", [7, 10, 5, 21, 6, 11, 5, 23, 5, 11, 18, 7, 21, 13]),
                e("#kt_table_widget_14_chart_2", [17, 5, 23, 2, 21, 9, 17, 23, 4, 24, 9, 17, 21, 7]),
                e("#kt_table_widget_14_chart_3", [2, 24, 5, 17, 7, 2, 12, 24, 5, 24, 2, 8, 12, 7]),
                e("#kt_table_widget_14_chart_4", [24, 3, 5, 19, 3, 7, 25, 14, 5, 14, 2, 8, 5, 17]),
                e("#kt_table_widget_14_chart_5", [3, 23, 1, 19, 3, 17, 3, 9, 25, 4, 2, 18, 25, 3]);
        },
    };
})();
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_widget_table_3")) &&
                ((a = $(e).DataTable({ info: !1, order: [], paging: !1, pageLength: !1 })),
                (() => {
                    ...
                    e.forEach((l) => {
                        l.addEventListener("click", (o) => {
                            ...
                            e.forEach((e) => {
                                ...
                                l.classList.add(...t),
                                "Show All" === r ? a.search("").draw() : a.search(r).draw();
                        });
                    });
                })(),
                t());
    ...
    const l = () => {
        ...
        i = (a, l) => {
            a.forEach((o, r) => {
                ...
                s.setAttribute("src", u + o.image + ".gif"),
                    (n.innerText = o.name),
                    (m.innerText = o.description),
                    (d.innerText = o.cost),
                    (g.innerText = o.qty),
                    (c.innerText = o.total),
                    o.stock > 10 ? (f.innerHTML = '<div class="badge badge-light-success">In Stock</div>') : (f.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>'),
                    1 === a.length || a.length;
        ...
        init: function () {
            (e = document.querySelector("#kt_table_widget_4_table")) &&
                ((() => {
                    ...
                    (t = l.cloneNode(!0)).classList.remove("d-none"),
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_table_widget_5_table")) &&
                ...
                (a = $(e).DataTable({ info: !1, order: [], lengthChange: !1, pageLength: 6, paging: !1, columnDefs: [{ orderable: !1, targets: 1 }] })),
                t());
        },
    };
})();
...
var KTFormsWidget1 = {
    init: function () {
        ...
        (e = function (e) {
            ...
            $("#kt_forms_widget_1_select_1").select2({ placeholder: "Select coin", minimumResultsForSearch: 1 / 0, templateSelection: e, templateResult: e });
    },
};
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var t = a.container.children.push(am5map.MapChart.new(a, { panX: "translateX", panY: "translateY", projection: am5map.geoMercator(), paddingLeft: 0, paddingrIGHT: 0, paddingBottom: 0 })),
                            l = t.series.push(am5map.MapPolygonSeries.new(a, { geoJSON: am5geodata_worldLow, exclude: ["AQ"] }));
                        ...
                        var o = t.series.push(am5map.MapPolygonSeries.new(a, { geoJSON: am5geodata_worldLow, include: ["US", "BR", "DE", "AU", "JP"] }));
                        o.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0 }),
                            am5.ColorSet.new(a, {}),
                            o.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))),
                            o.mapPolygons.template.states.create("hover", { fill: a.interfaceColors.get("primaryButtonHover") }),
                            o.mapPolygons.template.states.create("active", { fill: a.interfaceColors.get("primaryButtonHover") }),
                    ...
                    "#kt_timeline_widget_1_tab_week" === e.getAttribute("href") &&
                        (() => {
                            ...
                            var t = Date.now(),
                                ...
                                r = new vis.DataSet([
                                    { id: 1, group: 1, start: t, end: moment(t).add(7, "days"), content: "Framework", progress: "71%", color: "primary", users: ["avatars/300-6.jpg", "avatars/300-1.jpg"] },
                                    { id: 2, group: 2, start: moment(t).add(7, "days"), end: moment(t).add(14, "days"), content: "Accessibility", progress: "84%", color: "success", users: ["avatars/300-2.jpg"] },
                                    { id: 3, group: 3, start: moment(t).add(3, "days"), end: moment(t).add(20, "days"), content: "Microsites", progress: "69%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-20.jpg"] },
                                    {
                                        id: 4,
                                        group: 4,
                        ...
                        "#kt_timeline_widget_1_tab_month" === e.getAttribute("href") &&
                            (() => {
                                ...
                                var t = Date.now(),
                                    ...
                                    r = new vis.DataSet([
                                        { id: 1, group: "research", start: t, end: moment(t).add(2, "months"), content: "Tags", progress: "79%", color: "primary", users: ["avatars/300-6.jpg", "avatars/300-1.jpg"] },
                                        { id: 2, group: "qa", start: moment(t).add(0.5, "months"), end: moment(t).add(5, "months"), content: "Testing", progress: "64%", color: "success", users: ["avatars/300-2.jpg"] },
                                        { id: 3, group: "ui", start: moment(t).add(2, "months"), end: moment(t).add(6.5, "months"), content: "Media", progress: "82%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-20.jpg"] },
                                        {
                                            id: 4,
                                            group: "dev",
        ...
        init: function () {
            (() => {
                ...
                var t = Date.now(),
                    ...
                    r = new vis.DataSet([
                        { id: 1, group: "research", start: t, end: moment(t).add(1.5, "hours"), content: "Meeting", progress: "60%", color: "primary", users: ["avatars/300-6.jpg", "avatars/300-1.jpg"] },
                        { id: 2, group: "qa", start: moment(t).add(1, "hours"), end: moment(t).add(2, "hours"), content: "Testing", progress: "47%", color: "success", users: ["avatars/300-2.jpg"] },
                        { id: 3, group: "ui", start: moment(t).add(30, "minutes"), end: moment(t).add(2.5, "hours"), content: "Landing page", progress: "55%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-20.jpg"] },
                        {
                            id: 4,
                            group: "dev",
    ...
    init: function () {
        ...
        (e = document.querySelector("#kt_timeline_widget_2_card")) &&
            KTUtil.on(e, '[data-kt-element="checkbox"]', "change", function (e) {
                ...
                !0 === this.checked
                    ? (a.classList.add("form-check-success"), l.classList.remove("bg-primary"), l.classList.add("bg-success"), (o.innerText = "Done"), o.classList.remove("badge-light-primary"), o.classList.add("badge-light-success"))
                    : (a.classList.remove("form-check-success"),
                      l.classList.remove("bg-success"),
                      l.classList.add("bg-primary"),
                      (o.innerText = "In Process"),
                      o.classList.remove("badge-light-success"),
                      o.classList.add("badge-light-primary"));
            });
    },
};
                        ...
                        "#kt_timeline_widget_4_tab_2022" === e.getAttribute("href") &&
                            (() => {
                                ...
                                var t = Date.now(),
                                    ...
                                    r = new vis.DataSet([
                                        { id: 1, group: "research", start: t, end: moment(t).add(2, "months"), content: "Tags", progress: "51%", color: "primary", users: ["avatars/300-7.jpg", "avatars/300-2.jpg"] },
                                        { id: 2, group: "qa", start: moment(t).add(0.5, "months"), end: moment(t).add(5, "months"), content: "Testing", progress: "64%", color: "success", users: ["avatars/300-2.jpg"] },
                                        { id: 3, group: "ui", start: moment(t).add(2, "months"), end: moment(t).add(6.5, "months"), content: "Media", progress: "54%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-21.jpg"] },
                                        {
                                            id: 4,
                                            group: "dev",
                                            start: moment(t).add(4, "months"),
...
var KTChartsWidget10 = (function () {
    ...
    return {
        init: function () {
            e("#kt_charts_widget_10_tab_1", "#kt_charts_widget_10_chart_1", [30, 18, 43, 70, 13, 37, 23], !0),
                e("#kt_charts_widget_10_tab_2", "#kt_charts_widget_10_chart_2", [25, 55, 35, 50, 45, 20, 31], !1),
                e("#kt_charts_widget_10_tab_3", "#kt_charts_widget_10_chart_3", [45, 15, 35, 70, 45, 50, 21], !1),
                e("#kt_charts_widget_10_tab_4", "#kt_charts_widget_10_chart_4", [15, 55, 25, 50, 25, 60, 31], !1);
        },
    };
})();
...
var KTChartsWidget11 = (function () {
    ...
    return {
        init: function () {
            e("#kt_chart_widget_11_tab_1", "#kt_chart_widget_11_chart_1", [16, 19, 19, 16, 16, 14, 15, 15, 17, 17, 19, 19, 18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 20, 20, 22], !1),
                e("#kt_chart_widget_11_tab_2", "#kt_chart_widget_11_chart_2", [18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22, 15, 18, 18, 17, 17, 15, 15, 17, 17, 19, 17], !1),
                e("#kt_chart_widget_11_tab_3", "#kt_chart_widget_11_chart_3", [17, 20, 20, 19, 19, 17, 17, 19, 19, 21, 21, 19, 19, 21, 21, 18, 18, 16, 17, 17, 19, 19, 21, 21, 19, 19, 17, 17, 18, 18], !0);
        },
    };
})();
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        var a = am5.Root.new(e);
                        a.setThemes([am5themes_Animated.new(a)]);
                        var t = a.container.children.push(am5xy.XYChart.new(a, { panX: !0, panY: !0, wheelX: "panX", wheelY: "zoomX" }));
                        ...
                        var l = [
                            ...
                            o = t.xAxes.push(am5xy.CategoryAxis.new(a, { categoryField: "year", startLocation: 0.5, endLocation: 0.5, renderer: am5xy.AxisRendererX.new(a, {}), tooltip: am5.Tooltip.new(a, {}) }));
                        ...
                        function i(e, i, s) {
                            var n = t.series.push(
                                am5xy.LineSeries.new(a, {
                                    ...
                                    categoryXField: "year",
                                    fill: am5.color(s),
                                    tooltip: am5.Tooltip.new(a, { pointerOrientation: "horizontal", labelText: "[bold]{name}[/]\n{categoryX}: {valueY}" }),
                                })
                            );
                            n.fills.template.setAll({ fillOpacity: 0.5, visible: !0 }), n.data.setAll(l), n.appear(1e3);
                        }
                        r.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }),
                            ...
                            t.set("scrollbarX", am5.Scrollbar.new(a, { orientation: "horizontal", marginBottom: 25, height: 8 }));
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        var a = am5.Root.new(e);
                        a.setThemes([am5themes_Animated.new(a)]);
                        var t = a.container.children.push(am5radar.RadarChart.new(a, { panX: !1, panY: !1, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(20), startAngle: -90, endAngle: 180 })),
                            l = [
                        ...
                        var r = t.xAxes.push(am5xy.ValueAxis.new(a, { renderer: o, min: 0, max: 100, strictMinMax: !0, numberFormat: "#'%'", tooltip: am5.Tooltip.new(a, {}) })),
                        ...
                        s.data.setAll(l);
                        var n = t.series.push(am5radar.RadarColumnSeries.new(a, { xAxis: r, yAxis: s, clustered: !1, valueXField: "full", categoryYField: "category", fill: a.interfaceColors.get("alternativeBackground") }));
                        n.columns.template.setAll({ width: am5.p100, fillOpacity: 0.08, strokeOpacity: 0, cornerRadius: 20 }), n.data.setAll(l);
                        var m = t.series.push(am5radar.RadarColumnSeries.new(a, { xAxis: r, yAxis: s, clustered: !1, valueXField: "value", categoryYField: "category" }));
                        m.columns.template.setAll({ width: am5.p100, strokeOpacity: 0, tooltipText: "{category}: {valueX}%", cornerRadius: 20, templateField: "columnSettings" }),
                            m.data.setAll(l),
                            n.appear(1e3),
                            m.appear(1e3),
                            t.appear(1e3, 100);
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        var a = am5.Root.new(e);
                        a.setThemes([am5themes_Animated.new(a)]);
                        var t = a.container.children.push(am5xy.XYChart.new(a, { panX: !1, panY: !1, layout: a.verticalLayout })),
                            l =
                                (t.get("colors"),
                                [
                            ...
                            o = t.xAxes.push(
                                am5xy.CategoryAxis.new(a, {
                                    ...
                                    bullet: function (e, a, t) {
                                        return am5xy.AxisBullet.new(e, { location: 0.5, sprite: am5.Picture.new(e, { width: 24, height: 24, centerY: am5.p50, centerX: am5.p50, src: t.dataContext.icon }) });
                                    },
                                })
                            );
                        o.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 10, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            o.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }),
                            o.data.setAll(l);
                        var r = t.yAxes.push(am5xy.ValueAxis.new(a, { renderer: am5xy.AxisRendererY.new(a, {}) }));
                        r.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }),
                            r.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 10, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) });
                        var i = t.series.push(am5xy.ColumnSeries.new(a, { xAxis: o, yAxis: r, valueYField: "visits", categoryXField: "country" }));
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        var a = am5.Root.new(e);
                        a.setThemes([am5themes_Animated.new(a)]);
                        var t = a.container.children.push(am5xy.XYChart.new(a, { panX: !1, panY: !1, wheelX: "panX", wheelY: "zoomX", layout: a.verticalLayout })),
                            l =
                                (t.get("colors"),
                                [
                        ...
                        var o = t.xAxes.push(am5xy.CategoryAxis.new(a, { categoryField: "country", renderer: am5xy.AxisRendererX.new(a, { minGridDistance: 30 }) }));
                        o.get("renderer").labels.template.setAll({ paddingTop: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            o.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }),
                            o.data.setAll(l);
                        var r = t.yAxes.push(am5xy.ValueAxis.new(a, { renderer: am5xy.AxisRendererY.new(a, {}) }));
                        r.get("renderer").labels.template.setAll({ paddingLeft: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            r.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] });
                        ...
                        var n = t.series.push(am5xy.ColumnSeries.new(a, { xAxis: o, yAxis: r, valueYField: "visits", categoryXField: "country" }));
                        ...
                        var m = t.series.push(am5xy.LineSeries.new(a, { xAxis: o, yAxis: s, valueYField: "pareto", categoryXField: "country", stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")), maskBullets: !1 }));
                        m.bullets.push(function () {
                            return am5.Bullet.new(a, { locationY: 1, sprite: am5.Circle.new(a, { radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")) }) });
                        }),
                            n.data.setAll(l),
                            m.data.setAll(l),
                            n.appear(),
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var t = a.container.children
                            .push(am5percent.PieChart.new(a, { startAngle: 180, endAngle: 360, layout: a.verticalLayout, innerRadius: am5.percent(50) }))
                            .series.push(am5percent.PieSeries.new(a, { startAngle: 180, endAngle: 360, valueField: "value", categoryField: "category", alignLabels: !1 }));
                        t.labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            t.states.create("hidden", { startAngle: 180, endAngle: 180 }),
                            t.slices.template.setAll({ cornerRadius: 5 }),
                            t.ticks.template.setAll({ forceHidden: !0 }),
                            t.data.setAll([
        ...
        !(function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    s = new ApexCharts(e, {
                        series: [{ name: i, data: [34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5, 35, 35, 35.4, 35.4, 35] }],
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var t = a.container.children.push(am5xy.XYChart.new(a, { panX: !1, panY: !1, layout: a.verticalLayout })),
                            ...
                            o = t.xAxes.push(am5xy.CategoryAxis.new(a, { categoryField: "year", renderer: am5xy.AxisRendererX.new(a, {}) }));
                        o.data.setAll(l),
                            o.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            o.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 });
                        var r = t.yAxes.push(am5xy.ValueAxis.new(a, { min: 0, extraMax: 0.1, renderer: am5xy.AxisRendererY.new(a, {}) }));
                        r.get("renderer").labels.template.setAll({ paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            r.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] });
                        var i = t.series.push(
                            am5xy.ColumnSeries.new(a, {
                                ...
                                valueYField: "income",
                                categoryXField: "year",
                                tooltip: am5.Tooltip.new(a, { pointerOrientation: "horizontal", labelText: "{name} in {categoryX}: {valueY} {info}" }),
                            })
                        );
                        ...
                        s.strokes.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-success")) }),
                            ...
                            s.bullets.push(function () {
                                return am5.Bullet.new(a, {
                                    sprite: am5.Circle.new(a, { strokeWidth: 3, stroke: am5.color(KTUtil.getCssVariableValue("--bs-success")), radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--bs-light-success")) }),
                                });
                            }),
                            i.columns.template.setAll({ strokeOpacity: 0, cornerRadiusBR: 0, cornerRadiusTR: 6, cornerRadiusBL: 0, cornerRadiusTL: 6 }),
                            t.set("cursor", am5xy.XYCursor.new(a, {})),
                            t.get("cursor").lineX.setAll({ visible: !1 }),
                            t.get("cursor").lineY.setAll({ visible: !1 }),
                            t.children.push(am5.Legend.new(a, { centerX: am5.p50, x: am5.p50 })).data.setAll(t.series.values),
                            t.appear(1e3, 100),
                            i.appear();
                    });
            }
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var r = o.container.children.push(am5.Container.new(o, { layout: o.horizontalLayout, width: am5.p100, height: am5.p100 }));
                        o.numberFormatter.setAll({ numberFormat: "#.##as" });
                        var i = r.children.push(am5xy.XYChart.new(o, { panX: !1, panY: !1, wheelX: "none", wheelY: "none", layout: o.verticalLayout, width: am5.percent(60) })),
                            s = i.yAxes.push(am5xy.CategoryAxis.new(o, { categoryField: "age", renderer: am5xy.AxisRendererY.new(o, {}) }));
                        s.get("renderer").labels.template.setAll({ paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            ...
                            s.data.setAll(a);
                        var n = i.yAxes.push(am5xy.CategoryAxis.new(o, { categoryField: "age", renderer: am5xy.AxisRendererY.new(o, { opposite: !0 }) }));
                        n.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }),
                            ...
                            n.data.setAll(a);
                        var m = i.xAxes.push(am5xy.ValueAxis.new(o, { min: -10, max: 10, numberFormat: "#.s'%'", renderer: am5xy.AxisRendererX.new(o, { minGridDistance: 40 }) }));
                        m.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            m.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 });
                        var d = i.series.push(am5xy.ColumnSeries.new(o, { name: "Males", xAxis: m, yAxis: s, valueXField: "malePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-success")), clustered: !1 }));
                        d.columns.template.setAll({ tooltipText: "Males, age {categoryY}: {male} ({malePercent.formatNumber('#.0s')}%)", tooltipX: am5.p100, cornerRadiusBR: 4, cornerRadiusTR: 4, cornerRadiusBL: 0, cornerRadiusTL: 0 }),
                            d.data.setAll(a);
                        var g = i.series.push(
                            am5xy.ColumnSeries.new(o, { name: "Males", xAxis: m, yAxis: s, valueXField: "femalePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), clustered: !1 })
                        );
                        g.columns.template.setAll({ tooltipText: "Males, age {categoryY}: {female} ({femalePercent.formatNumber('#.0s')}%)", tooltipX: am5.p100, cornerRadiusBR: 4, cornerRadiusTR: 4, cornerRadiusBL: 0, cornerRadiusTL: 0 }),
                            g.data.setAll(a),
                            i.plotContainer.children.push(am5.Label.new(o, { text: "Males", fontSize: 13, fontWeight: "500", y: 5, x: 5, fill: d.get("fill") })),
                            i.plotContainer.children.push(am5.Label.new(o, { text: "Females", fontSize: 13, fontWeight: "500", y: 5, x: am5.p100, centerX: am5.p100, dx: -5, fill: g.get("fill") }));
                        var c = r.children.push(am5map.MapChart.new(o, { panX: "none", panY: "none", wheelY: "none", projection: am5map.geoAlbersUsa(), width: am5.percent(40) }));
                        i.getTooltip().set("autoTextColor", !1);
                        var f,
                            u = c.children.push(am5.Label.new(o, { text: "United States", fontSize: 14, fontWeight: "500", fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800")), y: 20, x: am5.p50, centerX: am5.p50 })),
                            p = c.series.push(am5map.MapPolygonSeries.new(o, { fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), geoJSON: am5geodata_usaLow }));
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        var a = am5.Root.new(e);
                        a.setThemes([am5themes_Animated.new(a)]);
                        var t = a.container.children.push(am5radar.RadarChart.new(a, { panX: !1, panY: !1, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(40), radius: am5.percent(70), arrangeTooltips: !1 }));
                        t.set("cursor", am5radar.RadarCursor.new(a, { behavior: "zoomX" })).lineY.set("visible", !1);
                        ...
                        l.labels.template.setAll({ textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700")) }),
                            l.grid.template.setAll({ location: 0.5, strokeDasharray: [2, 2] });
                        var o = t.xAxes.push(am5xy.CategoryAxis.new(a, { maxDeviation: 0, categoryField: "name", renderer: l })),
                        ...
                        var s = t.series.push(am5radar.RadarLineSeries.new(a, { name: "Revenue", xAxis: o, yAxis: i, valueYField: "value1", categoryXField: "name", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) }));
                        ...
                        n.strokes.template.setAll({ strokeOpacity: 0 }),
                            n.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5 }),
                            t.radarContainer.children.push(am5.Legend.new(a, { width: 150, centerX: am5.p50, centerY: am5.p50 })).data.setAll([s, n]);
                        var m = [
        ...
        !(function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = e.getAttribute("data-kt-chart-info"),
                    s = new ApexCharts(e, {
                        series: [{ name: i, data: [34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5, 35, 35, 35.5, 35.5, 35] }],
                        chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 } },
                        plotOptions: {},
                        legend: { show: !1 },
                        dataLabels: { enabled: !1 },
...
var KTChartsWidget32 = (function () {
    ...
    return {
        init: function () {
            e("#kt_charts_widget_32_tab_1", "#kt_charts_widget_32_chart_1", [54, 42, 75, 110, 23, 87, 50], !0),
                e("#kt_charts_widget_32_tab_2", "#kt_charts_widget_32_chart_2", [25, 55, 35, 50, 45, 20, 31], !1),
                e("#kt_charts_widget_32_tab_3", "#kt_charts_widget_32_chart_3", [45, 15, 35, 70, 45, 50, 21], !1);
        },
    };
})();
...
var KTChartsWidget33 = (function () {
    var e = function (e, a, t, l, o) {
        ...
        if (r) {
            ...
            !0 === o && (g.render(), (c = !0)),
                f.addEventListener("shown.bs.tab", function (e) {
                    0 == c && (g.render(), (c = !0));
                });
        }
    };
...
var KTChartsWidget8 = (function () {
    var e = function (e, a, t, l) {
        ...
        if (o) {
            var r = parseInt(KTUtil.css(o, "height")),
                ...
                s = {
                    series: [
                        { name: "Social Campaigns", data: t[0] },
                        { name: "Email Newsletter", data: t[1] },
                        { name: "TV Campaign", data: t[2] },
                        { name: "Google Ads", data: t[3] },
                        { name: "Courses", data: t[4] },
                        { name: "Radio", data: t[5] },
                    ],
    ...
    return {
        init: function () {
            e("#kt_chart_widget_8_week_toggle", "#kt_chart_widget_8_week_chart", [[[100, 250, 30]], [[225, 300, 35]], [[300, 350, 25]], [[350, 350, 20]], [[450, 400, 25]], [[550, 350, 35]]], !1),
                e("#kt_chart_widget_8_month_toggle", "#kt_chart_widget_8_month_chart", [[[125, 300, 40]], [[250, 350, 35]], [[350, 450, 30]], [[450, 250, 25]], [[500, 500, 30]], [[600, 250, 28]]], !0);
        },
    };
})();
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = {
                        ...
                        colors: [o, r],
                        grid: { borderColor: l, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                        markers: { colors: [o, r], strokeColor: [KTUtil.getCssVariableValue("--bs-danger"), KTUtil.getCssVariableValue("--bs-warning")], strokeWidth: 3 },
                    },
    ...
    init: function () {
        !(function () {
            ...
            if (e) {
                ...
                (t.width = t.height = a.size), e.appendChild(l), e.appendChild(t), o.translate(a.size / 2, a.size / 2), o.rotate((a.rotate / 180 - 0.5) * Math.PI);
                ...
                i("#E4E6EF", a.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-primary"), a.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-success"), a.lineWidth, 0.4);
            }
        })();
    },
};
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    o = new ApexCharts(e, {
                        ...
                        colors: [l],
                        grid: { strokeDashArray: 4, padding: { top: 0, right: -20, bottom: -20, left: -20 }, yaxis: { lines: { show: !0 } } },
    ...
    init: function () {
        !(function () {
            ...
            if (e) {
                ...
                i("#E4E6EF", a.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-danger"), a.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-primary"), a.lineWidth, 0.4);
            }
        })();
    },
};
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = new ApexCharts(e, {
                        ...
                        xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1, tickPlacement: "between" }, labels: { show: !1, style: { colors: t, fontSize: "12px" } }, crosshairs: { show: !1 } },
...
var KTPlayersWidget1 = {
    init: function () {
        KTUtil.on(document.body, '[data-kt-element="list-play-button"]', "click", function (e) {
            ...
            o.classList.contains("d-none") ? (t.play(), l.classList.add("d-none"), o.classList.remove("d-none")) : (t.pause(), l.classList.remove("d-none"), o.classList.add("d-none")),
