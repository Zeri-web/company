"use strict";
var KTModalCreateRecipe = (function () {
    var t, e, n, a, o, i;
    return {
        init: function () {
            (i = document.querySelector("#kt_modal_create_recipe")) &&
                ((o = new bootstrap.Modal(i)),
                (a = document.querySelector("#kt_modal_create_recipe_form")),
                (t = document.getElementById("kt_modal_create_recipe_submit")),
                (e = document.getElementById("kt_modal_create_recipe_cancel")),
                (n = FormValidation.formValidation(a, {
                    fields: {
                        ...
                        recipe_attachment: {
                            validators: {
                                notEmpty: { message: "Recipe attachment is required" },
                            },
                        },
                    },
                                        ...
                                        ? (t.setAttribute("data-kt-indicator", "on"),
                                          ...
                                          setTimeout(function () {
                                              t.removeAttribute("data-kt-indicator"),
                                                  ...
                                                  document.getElementById("kt_modal_create_recipe_form").submit();
                                          }, 2e3))
                                        : Swal.fire({
