"use strict";
var KTModalCreateSubTheme = (function () {
    var t, e, n, a, o, i;
    return {
        init: function () {
            (i = document.querySelector("#kt_modal_create_sub_theme")) &&
                ((o = new bootstrap.Modal(i)),
                (a = document.querySelector("#kt_modal_create_sub_theme_form")),
                (t = document.getElementById("kt_modal_create_sub_theme_submit")),
                (e = document.getElementById("kt_modal_create_sub_theme_cancel")),
                (n = FormValidation.formValidation(a, {
                    fields: {
                        theme_id: { validators: { notEmpty: { message: "Select theme is required" } } },
                                        ...
                                        ? (t.setAttribute("data-kt-indicator", "on"),
                                          ...
                                          setTimeout(function () {
                                              t.removeAttribute("data-kt-indicator"),
                                                  ...
                                                  document.getElementById("kt_modal_create_sub_theme_form").submit();
                                          }, 2e3))
                                        : Swal.fire({
